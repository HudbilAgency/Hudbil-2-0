    ...
    return (
        <>
            ...
            <div className="w-full h-[70vh] lg:h-[80vh] bg-no-repeat bg-cover bg-center">
                ...
                >
                    <source src="/services3-video.mp4" type="video/mp4" />
                ...
                <section className='bg-black py-20'>
                    ...
                    <div className="relative my-24">
                        <div className="relative">
                            <img className='mx-auto transition duration-500 grayscale hover:grayscale-0' src="/services3-midimg.png" alt="Creative Designing Services" />
