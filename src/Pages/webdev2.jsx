...
const WebDev2 = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Development Agency in Pune | Custom Web & App Development Solutions</title>
                <meta name="description" content="Looking for a development agency in Pune? We provide expert web and app development services, offering innovative and custom solutions to enhance your online presence and drive business growth."></meta>
                <meta property="og:url" content="www.hudbil.com/website-development-agency-in-pune"></meta>
                <meta name="keywords" content="development agency Pune, web development agency Pune, mobile app development Pune, software development Pune, website design Pune, custom development Pune, app development services Pune"></meta>
                <meta name="og:description" content="Our development agency in Pune specializes in custom web and mobile app development, creating innovative solutions to help businesses grow, enhance their digital presence, and achieve measurable results."></meta>
                ...
                <section>
                    <div className={`flex flex-col lg:flex-row justify-between ${isScreenTall ? 'h-screen' : 'h-full'}`}>
                        <div className='w-full lg:w-1/2 min-h-full bg-black lg:border-b-[1px] border-opacity-50 border-white flex flex-col pt-36 md:pt-40 pb-20 lg:pt-48 lg:pb-40 items-start justify-center text-white px-6 lg:px-16'>
                            <div className='text-4xl md:text-[3rem] leading-tight'>Website Development Agency in Pune.</div>
                        ...
                        <div className="w-full lg:w-4/5 2xl:w-[70%] lg:ml-auto flex items-start">
                            ...
                            <div>
                                <div className='flex flex-col md:flex-row gap-10 pt-20 items-start justify-between font-normal px-6 lg:px-16'>
                                    <div className='text-4xl leading-tight w-full md:w-2/5 2xl:w-1/3'>Best Website Development Agency In Pune.</div>
                                    <div className='w-full md:w-2/5 2xl:w-1/3 mt-2 flex flex-col gap-6'>
                                        <div className="leading-normal">
                                            Where innovation meets functionality. As a leading website development agency in Pune, we specialise in creating custom, scalable, and high-performance websites that help businesses grow and thrive in the digital age.
                                        </div>
