        ...
        <>
            ...
            <main className='-mt-[100vh] pt-[40px]'>
                ...
                <section className='flex flex-col-reverse lg:flex-row items-start justify-between gap-20 lg:gap-10 py-10 lg:py-20 2xl:pb-28 px-6 lg:px-16'>
                    <div className='w-full relative lg:w-2/3 2xl:w-3/4 flex items-start h-full gap-0 lg:gap-10 pb-16 lg:pb-0'>
                        <div className='w-full'>
                            <div className='font-normal text-4xl pb-12 hidden lg:block leading-snug'>
                                Terms and Conditions
                            </div>
                            <div>
                                <img className='w-full' src="./TandC.png" />
                            </div>
                            <div className='flex flex-col gap-8 pt-12'>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                        <div>Agreement of Terms</div>
                                    </div>
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>These Terms of Use constitute a legally binding agreement made between you, whether
                                            personally or on behalf of an entity (“you”) and Hudbil Private Limited Infotech Private
                                            Limited , doing business as Hudbil Private Limited (“Hudbil Private Limited” , “we”, “us” or “our”), concerning your access to and use of the https://www.hudbil.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in India
                                            and have our registered office at NO 235, 2 nd  &amp; 3 rd  Floor, 13 th  Cross Rd,  Indiranagar II Stage, Hoysala Nagar, INDIRANAGAR, BANGALORE-38. You agree that by
                                            accessing the Site, you have read, understood, and agreed to be bound by all of these Terms
                                            of Use.</div>
                                        <div>IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and conditions or documents that may be posted on the Site from time
                                            ...
                                            Site after the date such revised Terms of Use are posted.</div>
                                        <div>IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and conditions or documents that may be posted on the Site from time
                                            to time are hereby expressly incorporated herein by reference. We reserve the right, in our
                                            sole discretion, to make changes or modifications to these Terms of Use from time to time .
                                            We will alert you about any changes by updating the “Last updated” date of these Terms of
                                            ...
                                            and to have accepted, the changes in any revised Terms of Use by your continued use of the
                                            Site after the date such revised Terms of Use are posted.</div>
                                        <div>The Site is not tailored to comply with industry-specific regulations (Health Insurance
                                            ...
                                            (GLBA).</div>
                                        <div>The Site is intended for users who are at least 18 years old. Persons under the age of 18 are
                                            not permitted to use or register for the Site.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>Unless otherwise indicated, the Site is our proprietary property and all source code, databases, functionality, software, website designs, audio, video, text, photographs, and
                                            ...
                                            your information and personal use only. Except as expressly provided in these Terms of Use, no part of the Site and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted,
                                            distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever,
                                            without our express prior written permission.</div>
                                        <div>Provided that you are eligible to use the Site, you are granted a limited license to access and
                                            ...
                                            rights not expressly granted to you in and to the Site, the Content and the Marks.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>By using the Site, you represent and warrant that: (1) you have the legal capacity and you agree to comply with these Terms of Use; (2 ) you are not a minor in the jurisdiction in
                                            which you reside ; ( 3) you will not access the Site through automated or non-human means,
                                            whether through a bot, script, or otherwise; (4) you will not use the Site for any illegal or
                                            unauthorized purpose; and (5) your use of the Site will not violate any applicable law or
                                            regulation.</div>
                                        <div>If you provide any information that is untrue, inaccurate, not current, or incomplete, we
                                            have the right to suspend or terminate your account and refuse any and all current or future
                                            use of the Site (or any portion thereof).</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>You may not access or use the Site for any purpose other than that for which we make the
                                            Site available. The Site may not be used in connection with any commercial endeavours
                                            except those that are specifically endorsed or approved by us.
                                            As a user of the Site, you agree not to:</div>
                                        <li>Systematically retrieve data or other content from the Site to create or compile,
                                            directly or indirectly, a collection, compilation, database, or directory without
                                            written permission from us.</li>
                                        ...
                                        <li>Circumvent, disable, or otherwise interfere with security-related features of the Site,
                                            ...
                                            enforce limitations on the use of the Site and/or the Content contained therein.</li>
                                        <li>Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site.</li>
                                        <li>Use any information obtained from the Site in order to harass, abuse, or harm
                                            another person.</li>
                                        <li>Make improper use of our support services or submit false reports of abuse or
                                            misconduct.</li>
                                        <li>Use the Site in a manner inconsistent with any applicable laws or regulations.</li>
                                        <li>Engage in unauthorized framing of or linking to the Site.</li>
                                        <li>Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other material, including excessive use of capital letters and spamming (continuous
                                        ...
                                        <li>Except as may be the result of standard search engine or Internet browser usage,
                                            ...
                                            Site, or using or launching any unauthorized script or other software.</li>
                                        ...
                                        <li>Make any unauthorized use of the Site, including collecting usernames and/or email
                                            ...
                                            prettiness.</li>
                                        <li>Use the Site as part of any effort to compete with us or otherwise use the Site
                                            and/or the Content for any revenue-generating endeavour or commercial
                                            enterprise.</li>
                                        <li>Use the Site to advertise or offer to sell goods and services.</li>
                                        <li>Copy Content</li>
                                        <li>Submit Wrong Information</li>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>The Site may invite you to chat, contribute to, or participate in blogs, message boards,
                                            ...
                                            Contributions, you thereby represent and warrant that:</div>
                                        <li>The creation, distribution, transmission, public display, or performance, and the
                                            accessing, downloading, or copying of your Contributions do not and will not infringe the proprietary rights, including but not limited to the copyright, patent, trademark, trade secret, or moral rights of any third party.</li>
                                        <li>You are the creator and owner of or have the necessary licenses, rights, consents,
                                            ...
                                            Terms of Use.</li>
                                        <li>You have the written consent, release, and/or permission of each and every
                                            ...
                                            your Contributions in any manner contemplated by the Site and these Terms of Use.</li>
                                        <li>Your Contributions are not false, inaccurate, or misleading.</li>
                                        <li>Your Contributions are not unsolicited or unauthorized advertising, promotional
                                        ...
                                        <li>Your Contributions are not used to harass or threaten (in the legal sense of those
                                        ...
                                        <li>Your Contributions do not violate any applicable law concerning child pornography,
                                            or otherwise intended to protect the health or well-being of minors.</li>
                                        <li>Your Contributions do not include any offensive comments that are connected to
                                            race, national origin, gender, sexual preference, or physical handicap.</li>
                                        <li>Your Contributions do not otherwise violate, or link to material that violates, any
                                            provision of these Terms of Use, or any applicable law or regulation.</li>
                                        <div>Any use of the Site in violation of the foregoing violates these Terms of Use and may result
                                            in, among other things, termination or suspension of your rights to use the Site.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>By posting your Contributions to any part of the Site, you automatically grant, and you
                                            ...
                                            media formats and through any media channels.</div>
                                        <div>This license will apply to any form, media, or technology now known or hereafter
                                ...
                                <div className='flex flex-col items-start gap-4'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or
                                            other information regarding the Site (“Submissions”) provided by you to us are non-confidential and shall become our sole property. We shall own exclusive rights, including all
                                ...
                                <div className='flex flex-col items-start gap-4'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>The Site may contain (or you may be sent via the Site) links to other websites (“Third-Party
                                            ...
                                            in any way from any Third-Party Content or any contact with Third-Party Websites.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>We reserve the right, but not the obligation, to: (1) monitor the Site for violations of these
                                            ...
                                            limitation, notice, or liability, to remove from the Site or otherwise disable all files and
                                            content that are excessive in size or are in any way burdensome to our systems; and (5)
                                            otherwise manage the Site in a manner designed to protect our rights and property and to facilitate the proper functioning of the Site.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>We care about data privacy and security. By using the Site, you agree to be bound by our
                                            ...
                                            your data transferred to and processed in the United States.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                        <div>DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY
                                            Notifications</div>
                                    </div>
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>We respect the intellectual property rights of others. If you believe that any material
                                            ...
                                            federal law you may be held liable for damages if you make material misrepresentations in a
                                            Notification. Thus, if you are not sure that material located on or linked to by the Site
                                            infringes your copyright, you should consider first contacting an attorney.</div>
                                        <div>All Notifications should meet the requirements of DMCA 17 U.S.C. § 512(c)(3) and include
                                            the following information: (1) A physical or electronic signature of a person authorized to
                                            act on behalf of the owner of an exclusive right that is allegedly infringed; (2) identification
                                            of the copyrighted work claimed to have been infringed, or, if multiple copyrighted works
                                            ...
                                            information reasonably sufficient to permit us to locate the material; (4) information
                                            reasonably sufficient to permit us to contact the complaining party, such as an address,
                                            telephone number, and, if available, an email address at which the complaining party may
                                            be contacted; (5) a statement that the complaining party has a good faith belief that use of
                                            ...
                                            and under penalty of perjury, that the complaining party is authorized to act on behalf of
                                            the owner of an exclusive right that is allegedly infringed upon.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                        <div>Counter Notification</div>
                                    </div>
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>If you believe your own copyrighted material has been removed from the Site as a result of
                                            a mistake or misidentification, you may submit a written counter notification toour
                                            Designated Copyright Agentusing the contact information provided below (a “Counter
                                            Notification”). To be an effective Counter Notification under the DMCA, your Counter
                                            Notification must include substantially the following: (1) identification of the material that
                                            has been removed or disabled and the location at which the material appeared before it
                                            was removed or disabled; (2) a statement that you consent to the jurisdiction of the Federal
                                            ...
                                            service of process from the party that filed the Notification or the partys agent; (4) your
                                            ...
                                            physical or electronic signature.</div>
                                        <div>If you send us a valid, written Counter Notification meeting the requirements described
                                            above, we will restore your removed or disabled material, unless we first receive notice
                                            from the party filing the Notification informing us that such party has filed a court action to
                                            restrain you from engaging in infringing activity related to the material in question. Please
                                            note that if you materially misrepresent that the disabled or removed content was removed
                                            by mistake or misidentification, you may be liable for damages, including costs and
                                            attorneys fees. Filing a false Counter Notification constitutes perjury.</div>
                                        <div className='flex flex-col items-start gap-0'>
                                            <div>Designated Copyright Agent</div>
                                            <div className='text-blue-700'>Mukul Gupta</div>
                                            <div>Attn: Copyright Agent</div>
                                            <div>AB 65, Prafullkanan, Keshtopur</div>
                                            <div>Kolkata, West Bengal 70010
                                                - India</div>
                                            <div><a href="mailto:mukul@capitalnumbers.com" target='_blank' className="underline text-blue-700">
                                                mukul@capitalnumbers.com
                                            </a></div>
                                        </div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>These Terms of Use shall remain in full force and effect while you use the Site. WITHOUT
                                            ...
                                            THE SITE (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON
                                            ...
                                            WITHOUT WARNING, IN OUR SOLE DISCRETION.</div>
                                        <div>If we terminate or suspend your account for any reason, you are prohibited from registering
                                            ...
                                            without limitation pursuing civil, criminal, and injunctive redress.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>We reserve the right to change, modify, or remove the contents of the Site at any time or
                                            for any reason at our sole discretion without notice. However, we have no obligation to
                                            update any information on our Site. We also reserve the right to modify or discontinue all or
                                            part of the Site without notice at any time. We will not be liable to you or any third party for
                                            any modification, price change, suspension, or discontinuance of the Site.</div>
                                        <div>We cannot guarantee the Site will be available at all times. We may experience hardware,
                                            ...
                                            support the Site or to supply any corrections, updates, or releases in connection therewith.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>These Terms shall be governed by and defined following the laws of India . Hudbil Private
                                            Limited Infotech Private Limited and yourself irrevocably consent that the courts of India
                                ...
                                <div className='flex flex-col items-start gap-4'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        ...
                                        <div>To expedite resolution and control the cost of any dispute, controversy, or claim related to
                                            ...
                                            negotiations commence upon written notice from one Party to the other Party.</div>
                                        <div>Binding Arbitration</div>
                                        <div>Any dispute arising out of or in connection with this contract, including any question
                                            regarding its existence, validity, or termination, shall be referred to and finally resolved by
                                            the International Commercial Arbitration Court under the European Arbitration Chamber
                                            ...
                                            shall be one (1) . The seat, or legal place, of arbitration shall be Kolkata , India . The language
                                            of the proceedings shall be English . The governing law of the contract shall be the
                                            substantive law of India .</div>
                                        <div>Restrictions</div>
                                        <div>The Parties agree that any arbitration shall be limited to the Dispute between the Parties
                                            ...
                                            for any Dispute to be brought in a purported representative capacity on behalf of the
                                            general public or any other persons.</div>
                                        <div>Exceptions to Informal Negotiations and Arbitration</div>
                                        <div>The Parties agree that the following Disputes are not subject to the above provisions
                                            ...
                                            above, and the Parties agree to submit to the personal jurisdiction of that court.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>There may be information on the Site that contains typographical errors, inaccuracies, or
                                            ...
                                            the information on the Site at any time, without prior notice.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE
                                ...
                                <div className='flex flex-col items-start gap-4'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR
                                            ...
                                            REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO $100.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON
                                            ...
                                            APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates,
                                            ...
                                            limited to intellectual property rights; or (6) any overt harmful act toward any other user of
                                            the Site with whom you connected via the Site. Notwithstanding the foregoing, we reserve
                                            the right, at your expense, to assume the exclusive defense and control of any matter for
                                            ...
                                            action, or proceeding which is subject to this indemnification upon becoming aware of it.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>We will maintain certain data that you transmit to the Site for the purpose of managing the
                                            ...
                                            waive any right of action against us arising from any such loss or corruption of such data.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                        <div>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</div>
                                    </div>
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>Visiting the Site, sending us emails, and completing online forms constitute electronic
                                            ...
                                            means other than electronic means.</div>
                                    </div>
                                </div>
                                <div className='flex flex-col items-start gap-4'>
                                    <div className='font-normal text-2xl leading-9'>
                                    ...
                                    <div className='leading-7 font-normal text-base flex flex-col gap-4'>
                                        <div>These Terms of Use and any policies or operating rules posted by us on the Site or in respect
                                            ...
                                            defences you may have based on the electronic form of these Terms of Use and the lack of
                                            signing by the parties hereto to execute these Terms of Use.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='w-full lg:w-1/3 2xl:w-1/4'>
                        ...
                        <div className='w-full border border-[#B0B0B0] border-opacity-75 rounded-lg'>
                            ...
                            <div className='flex flex-col gap-4 pb-6 text-[#454343]'>
                                ...
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>4.</div>
                                    <div>Prohibited Activites</div>
                                </div>
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>5.</div>
                                    <div>User General Contributions</div>
                                </div>
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>6.</div>
                                    <div>Contribution License</div>
                                ...
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>8.</div>
                                    <div>Third - Party websites and Content</div>
                                </div>
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>9.</div>
                                    <div>Site - Management</div>
                                ...
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>11.</div>
                                    <div>Digital Millennium Copyright</div>
                                </div>
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>12.</div>
                                    <div>Terms and Termination</div>
                                </div>
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>13.</div>
                                    <div>Modification and Interruptions</div>
                                </div>
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>14.</div>
                                    <div>Governing Laws</div>
                                </div>
                                <div className='flex gap-8 items-start px-6 font-normal text-base leading-7'>
                                    <div>15.</div>
                                    <div>Dispute Resolution</div>
