          ...
          `}
            ...
            <main className='bg-black'>
                <section>
                    <div className={`flex flex-col lg:flex-row justify-between ${isScreenTall ? 'h-screen' : 'h-full'}`}>
                        <div className='w-full lg:w-1/2 min-h-full bg-black lg:border-b-[1px] border-opacity-50 border-white flex flex-col pt-36 md:pt-40 pb-20 lg:pt-48 lg:pb-40 items-start justify-center text-white px-6 lg:px-16'>
                            ...
                            <div className='mt-12'>
                                <button className='border rounded-full py-4 px-16 sm:px-20 text-white bg-purple-800 hover:bg-white hover:text-black mt-4'>
                                    Know More
                                </button>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div className='px-6 lg:px-16 pb-[6px]'>
                                    <div className='flex items-stretch justify-between h-full'>
                                        <div className='lg:w-2/5 2xl:w-1/3 min-h-full flex flex-col justify-between'>
                                ...
                                <div className='flex flex-col md:flex-row gap-10 pb-12 items-start justify-between font-normal px-6 lg:px-16'>
                                    ...
                                    <div className=' leading-normal w-full md:w-2/5 2xl:w-1/3 mt-2'>
                                        ...
                                        <div className=''>
                                            ...
                                            <div className='py-4 text-2xl'>Affordable Pricing</div>
                                            <div className='flex gap-3 ml-[5%] text-gray-400'>
                                                <span>•</span>
                                ...
                                <div className='px-6 lg:px-14 flex flex-col lg:flex-row items-start justify-between w-full gap-12 lg:gap-0'>
                                    ...
                                    <div className='lg:w-2/5 2xl:w-2/6 text-white'>
                ...
                <section className='bg-black'>
                    ...
                    <div className='bg-[#7811A5] pt-[5%] overflow-hidden w-full lg:w-4/5 2xl:w-[70%] lg:ml-auto items-start'>
                        <h2 className="lg:text-4xl text-3xl font-arial leading-none text-center text-white max-md:text-4xl uppercase">Meet our clients</h2>
                        <div className="overflow-hidden w-full">
                            <Slider {...settings}>

                                <div key={0} className="flex flex-col our-brands-section">
                                    <div className="flex overflow-hidden relative flex-col mt-14 max-w-full text-xs font-extralight tracking-wider text-center  text-teal-950 w-[304px] max-md:mt-10">
                                        <div className="flex overflow-hidden relative items-center justify-center flex-col group">
                ...
                <section className='bg-white px-6 lg:px-16 overflow-hidden w-full lg:w-4/5 2xl:w-[70%] lg:ml-auto items-start py-20'>
                    <div className="flex flex-col gap-40 xl:flex-row w-full items-start ">
                        <div className="flex w-50%">
                            <div className="flex gap-3 items-center text-base tracking-wider leading-none text-neutral-950 max-md:mt-10">
                                ...
                                <div className="my-auto  w-fit text-black text-2xl xl:text-xl 2xl:text-2xl">Clients we have successful
