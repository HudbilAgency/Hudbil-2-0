...
const WebDev11 = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Development Agency in Coimbatore | Custom Web & App Development Solutions</title>
                <meta name="description" content="Looking for a development agency in Coimbatore? We offer expert web and mobile app development services, providing tailored solutions to boost your digital presence and drive business growth."></meta>
                <meta property="og:url" content="www.hudbil.com/website-development-agency-in-coimbatore"></meta>
                <meta name="keywords" content="development agency Coimbatore, web development agency Coimbatore, mobile app development Coimbatore, software development Coimbatore, website design Coimbatore, custom development Coimbatore, app development services Coimbatore"></meta>
                <meta name="og:description" content="Our development agency in Coimbatore specializes in custom web and mobile app development, offering innovative solutions to enhance your digital presence and accelerate your business growth."></meta>
                ...
                <section>
                    <div className={`flex flex-col lg:flex-row justify-between ${isScreenTall ? 'h-screen' : 'h-full'}`}>
                        <div className='w-full lg:w-1/2 min-h-full bg-black lg:border-b-[1px] border-opacity-50 border-white flex flex-col pt-36 md:pt-40 pb-20 lg:pt-48 lg:pb-40 items-start justify-center text-white px-6 lg:px-16'>
                            <div className='text-4xl md:text-[3rem] leading-tight'>Website Development Agency in Coimbatore.</div>
                        ...
                        <div className="w-full lg:w-4/5 2xl:w-[70%] lg:ml-auto flex items-start">
                            ...
                            <div>
                                <div className='flex flex-col md:flex-row gap-10 pt-20 items-start justify-between font-normal px-6 lg:px-16'>
                                    <div className='text-4xl leading-tight w-full md:w-2/5 2xl:w-1/3'>Best Website Development Agency In Coimbatore.</div>
                                    <div className='w-full md:w-2/5 2xl:w-1/3 mt-2 flex flex-col gap-6'>
                                        <div className="leading-normal">
                                            Where innovation meets functionality. As a leading website development agency in Coimbatore, we specialise in creating custom, scalable, and high-performance websites that help businesses grow and thrive in the digital age.
                                        </div>
