    ...
    return (
        <>
            ...
            <div className="w-full h-[70vh] lg:h-[80vh] bg-no-repeat bg-cover bg-center">
                ...
                >
                    <source src="/modules4-video.mp4" type="video/mp4" />
                        ...
                        <div className='w-full lg:w-2/3 xl:w-1/2 text-white'>
                            ...
                            <div className="py-10 toggle-point flex flex-col">
                                <div className="flex items-center justify-between gap-6">
                                    <div className="flex items-center justify-between gap-6">
                                        <div className="flex-shrink-0"><img src="/module4-wl-1.png" alt="point" /></div>
                                        <div className="font-normal text-xl sm:text-2xl md:text-4xl leading-9 pl-[6px]">Brand Enhancement</div>
                                    </div>
                            ...
                            <div className="py-10 toggle-point flex flex-col">
                                <div className="flex items-center justify-between gap-6">
                                    <div className="flex items-center justify-between gap-6">
                                        <div className="flex-shrink-0"><img src="/module4-wl-2.png" alt="point" /></div>
                            ...
                            <div className="py-10 toggle-point flex flex-col">
                                <div className="flex items-center justify-between gap-6">
                                    <div className="flex items-center justify-between gap-6">
                                        <div className="flex-shrink-0"><img src="/module4-wl-3.png" alt="point" /></div>
                            ...
                            <div className="py-10 toggle-point flex flex-col">
                                <div className="flex items-center justify-between gap-6">
                                    <div className="flex items-center justify-between gap-6">
                                        <div className="flex-shrink-0"><img src="/module4-wl-4.png" alt="point" /></div>
