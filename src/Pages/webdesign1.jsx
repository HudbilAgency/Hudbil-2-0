                                ...
                                <div className='flex flex-col md:flex-row gap-10 pt-20 items-start justify-between font-normal px-6 lg:px-16'>
                                    ...
                                    <div className='w-full md:w-2/5 2xl:w-1/3 mt-2 flex flex-col gap-6'>
                                        <div className="leading-normal">
                                            As the top-rated website designing agency in Bangalore, we bring together a team of skilled designers, developers, and strategists with a mission to create stunning, functional, and user-friendly websites. From small businesses to enterprises, we build sites that align with our clients' goals and vision.
                                        </div>
                                    ...
                                    <div className=' w-full md:w-2/5 2xl:w-1/3 mt-2'>
                                        ...
                                        <div className='w-full text-white mt-12'>
                                            ...
                                            <div className="py-10 toggle-point flex flex-col">
                                                <div className="flex items-center gap-6 justify-between">
                                                    <div className="flex items-center justify-between gap-6">
                                                        <div className="font-normal text-xl md:text-3xl  leading-9">Mobile Application UI/UX</div>
                                                    </div>
                                            ...
                                            <div className="py-10 toggle-point flex flex-col">
                                                <div className="flex items-center gap-6 justify-between">
                                                    <div className="flex items-center justify-between gap-6">
                                                        <div className="font-normal text-xl md:text-3xl leading-9">Logo Design</div>
                                                    </div>
                                                ...
                                                <div className={`flex flex-col gap-6 overflow-hidden transition-all duration-500 ease-in-out ${dropdownStates[1] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                                    <div className="pt-10">Based in Bangalore, we specialise in crafting memorable logos that embody a brand's identity and values. With a team of experienced designers, we work with businesses of all sizes to create logos that leave a lasting impression, whether for startups, established brands, or personal projects.</div>
                                                </div>
                                            </div>
                                            <div className="bg-[#6C6C6C] h-[1px] w-full"></div>
                                            <div className="py-10 toggle-point flex flex-col">
                                                <div className="flex items-center gap-6 justify-between">
                                                    <div className="flex items-center justify-between gap-6">
                                                        <div className="font-normal text-xl md:text-3xl leading-9">Brochure Design</div>
                                                    </div>
                                            ...
                                            <div className="py-10 toggle-point flex flex-col">
                                                <div className="flex items-center gap-6 justify-between">
                                                    <div className="flex items-center justify-between gap-6">
                                                        <div className="font-normal text-xl md:text-3xl leading-9">Web Application Design</div>
                                                    </div>
                                            ...
                                            <div className="py-10 toggle-point flex flex-col">
                                                <div className="flex items-center gap-6 justify-between">
                                                    <div className="flex items-center justify-between gap-6">
                                                        <div className="font-normal text-xl md:text-3xl leading-9">Website Development</div>
                                                    </div>
                                            ...
                                            <div className="py-10 toggle-point flex flex-col">
                                                <div className="flex items-center gap-6 justify-between">
                                                    <div className="flex items-center justify-between gap-6">
                                                        <div className="font-normal text-xl md:text-3xl leading-9">Mobile Application Development</div>
                                                    </div>
