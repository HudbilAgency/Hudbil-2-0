...
const WebDesign5 = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Designing Agency in Ahmedabad | Creative Design Solutions for Your Brand</title>
                <meta name="description" content="Looking for a designing agency in Ahmedabad? We offer custom design solutions, including logo design, web design, UI/UX, and branding, to help elevate your brand identity and digital presence."></meta>
                <meta property="og:url" content="www.hudbil.com/website-designing-agency-in-ahmedabad"></meta>
                <meta name="keywords" content="designing agency Ahmedabad, graphic design agency Ahmedabad, logo design Ahmedabad, web design agency Ahmedabad, UI/UX design Ahmedabad, branding agency Ahmedabad, creative design services Ahmedabad"></meta>
                <meta name="og:description" content="Our designing agency in Ahmedabad specializes in delivering innovative and customized design services to enhance your brand’s identity. From logo and website design to UI/UX and branding, we create designs that resonate with your audience."></meta>
                ...
                <section>
                    <div className={`flex flex-col lg:flex-row justify-between ${isScreenTall ? 'h-screen' : 'h-full'}`}>
                        <div className='w-full lg:w-1/2 min-h-full bg-black lg:border-b-[1px] border-opacity-50 border-white flex flex-col pt-36 md:pt-40 pb-20 lg:pt-48 lg:pb-40 items-start justify-center text-white px-6 lg:px-16'>
                            <div className='text-4xl md:text-[3rem] leading-tight'>Website Designing Agency in Ahmedabad.</div>
                        ...
                        <div className="w-full lg:w-4/5 2xl:w-3/4 lg:ml-auto flex items-start">
                            ...
                            <div>
                                <div className='flex flex-col md:flex-row gap-10 pt-20 items-start justify-between font-normal px-6 lg:px-16'>
                                    <div className='text-4xl leading-tight w-full md:w-2/5 2xl:w-1/3'>Best Website Designing Agency In Ahmedabad.</div>
                                    <div className='w-full md:w-2/5 mt-2 flex flex-col gap-6'>
                                        <div className="leading-normal">
                                            As the top-rated website designing agency in Ahmedabad, we bring together a team of skilled designers, developers, and strategists with a mission to create stunning, functional, and user-friendly websites. From small businesses to enterprises, we build sites that align with our clients' goals and vision.
                                        </div>
                                        ...
                                        <div className='w-full text-white mt-12'>
                                            ...
                                            <div className="py-10 toggle-point flex flex-col">
                                                ...
                                                <div className={`flex flex-col gap-6 overflow-hidden transition-all duration-500 ease-in-out ${dropdownStates[1] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                                    <div className="pt-10">Based in Ahmedabad, we specialise in crafting memorable logos that embody a brand's identity and values. With a team of experienced designers, we work with businesses of all sizes to create logos that leave a lasting impression, whether for startups, established brands, or personal projects.</div>
                                                </div>
                                            </div>
                                            <div className="bg-[#6C6C6C] h-[1px] w-full"></div>
                                            <div className="py-10 toggle-point flex flex-col">
                                                ...
                                                <div className={`flex flex-col gap-6 overflow-hidden transition-all duration-500 ease-in-out ${dropdownStates[2] ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                                    <div className="pt-10">We specialise in creating impactful brochure designs that help businesses communicate their message effectively. Located in Ahmedabad, our team combines creativity with strategic design to produce brochures that are not only visually appealing but also align with your brand's goals. Whether for corporate events, marketing materials, or product catalogs, our brochures leave a lasting impression.</div>
                                                </div>
                                            </div>
                                            <div className="bg-[#6C6C6C] h-[1px] w-full"></div>
                                            <div className="py-10 toggle-point flex flex-col">
